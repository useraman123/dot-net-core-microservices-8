...
public class DiscountRepository : IDiscount
{
    ...
    public async Task<Coupon> GetDiscount(string productName)
    {
        ...
        if(coupon== null)
        {
            return new Coupon { ProductName = "No Discount", Amount = 0, Description = "No Discunt Available" };
        }
        return coupon;
    }
    ...
    public async Task<bool> CreateDiscount(Coupon coupon)
    {
        ...
        var affected = await connection.ExecuteAsync
            ("INSERT INTO Coupon(ProductName,Description,Amount) VALUES(@Productname,@Discription,@Amount)",
